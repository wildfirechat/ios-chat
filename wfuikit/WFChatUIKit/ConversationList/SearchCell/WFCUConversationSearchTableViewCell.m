...
- (UILabel *)targetView {
    if (!_targetView) {
        _targetView = [[UILabel alloc] initWithFrame:CGRectMake(16 + 28 + 16, 19, self.contentView.bounds.size.width - 68  - 68, 10)];
...
- (UILabel *)digestView {
    if (!_digestView) {
        _digestView = [[UILabel alloc] initWithFrame:CGRectMake(16 + 28 + 16, 34, self.contentView.bounds.size.width - 60  - 16, 14)];
...
- (UILabel *)timeView {
    if (!_timeView) {
        _timeView = [[UILabel alloc] initWithFrame:CGRectMake(self.contentView.bounds.size.width - 52  - 8, 18, 52, 12)];
