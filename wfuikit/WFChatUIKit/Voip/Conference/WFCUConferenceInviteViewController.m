...
- (void)viewDidLoad {
    ...
    self.conversations = [[[WFCCIMService sharedWFCIMService] getConversationInfos:@[@(Single_Type), @(Group_Type), @(SecretChat_Type)] lines:@[@(WFCCConversationLine_Default), @(WFCCConversationLine_Agent)]] mutableCopy];
