...
- (UILabel *)nameLabel {
    if (!_nameLabel) {
        ...
        _nameLabel.font = [UIFont scaledPingFangSCWithWeight:FontWeightStyleRegular size:11];
...
- (UILabel *)domainLabel {
    if (!_domainLabel) {
        ...
        _domainLabel.font = [UIFont scaledPingFangSCWithWeight:FontWeightStyleRegular size:11];
