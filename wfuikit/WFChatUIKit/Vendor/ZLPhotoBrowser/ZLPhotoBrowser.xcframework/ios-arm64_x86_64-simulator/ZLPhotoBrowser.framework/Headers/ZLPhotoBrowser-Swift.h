...
typedef SWIFT_ENUM(NSInteger, EditImageTool, open) {
  EditImageToolDraw = 0,
  EditImageToolClip = 1,
...
@property (nonatomic, strong) UIBlurEffect * _Nullable navViewBlurEffect SWIFT_DEPRECATED_MSG("Use navViewBlurEffectOfAlbumList, this property will be removed");
/// Bottom too bar blur effect.
@property (nonatomic, strong) UIBlurEffect * _Nullable bottomToolViewBlurEffect SWIFT_DEPRECATED_MSG("Use bottomViewBlurEffectOfAlbumList, this property will be removed");
