...
- (void)layoutSubviews {
    ...
    self.nameLabel.frame = CGRectMake(50 + portraitSize + 12, (self.frame.size.height - labelHeight) / 2.0, self.bounds.size.width - (16 + 20 + 19 + portraitSize + 12) - 48, labelHeight);
}
