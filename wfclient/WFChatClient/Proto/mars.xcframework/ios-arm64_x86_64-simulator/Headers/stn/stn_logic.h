...
namespace stn{
    ...
    public:
        ...
        //长连信令校验回包 
        virtual bool OnLonglinkIdentifyResponse(const AutoBuffer& _response_buffer, const AutoBuffer& _identify_buffer_hash, const std::string &host, const std::string &ip, int port) = 0;
