...
- (NSString *)formatNotification:(WFCCMessage *)message {
    ...
    if ([self.type isEqualToString:@"1"]) {
        formatMsg = [NSString stringWithFormat:WFCCString(@"AllowGroupMember"), formatMsg];
    } else {
        formatMsg = [NSString stringWithFormat:WFCCString(@"DisallowGroupMember"), formatMsg];
    }
    ...
    formatMsg = [formatMsg stringByAppendingString:WFCCString(@"SpeakingPermissionDuringMute")];
