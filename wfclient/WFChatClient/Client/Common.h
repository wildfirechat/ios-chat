...
//会议纪要消息
#define MESSAGE_CONTENT_TYPE_MEETING_MINUTES 25

//转换消息（透传消息）
#define MESSAGE_CONTENT_TYPE_TRANSCRIPTION 26
...
#define MESSAGE_CONTENT_TYPE_RESTORE_REQUEST 610
#define MESSAGE_CONTENT_TYPE_RESTORE_RESPONSE 611
#define MESSAGE_CONTENT_TYPE_BACKUP_RESPONSE 612
#define MESSAGE_CONTENT_TYPE_BACKUP_REQUEST 613
